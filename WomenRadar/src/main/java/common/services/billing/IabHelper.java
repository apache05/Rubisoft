...
class IabHelper {
    ...
    public static String getResponseDesc(int code) {
        ...
        if (code <= IABHELPER_ERROR_BASE) {
			...
			return index >= 0 && index < iabhelper_msgs.length ? iabhelper_msgs[index] : code + ":Unknown IAB Helper Error";
     ...
     */
    public void startSetup(@Nullable OnIabSetupFinishedListener listener) {
    ...
    private void launchPurchaseFlow(@NonNull Activity act, String sku, int requestCode,
    ...
    private void launchSubscriptionPurchaseFlow(@NonNull Activity act, String sku, int requestCode,
												OnIabPurchaseFinishedListener listener, String extraData) {
     ...
     */
	private void launchPurchaseFlow(@NonNull Activity act, String sku, @NonNull String itemType, int requestCode,
     ...
     */
	private void queryInventoryAsync(boolean querySkuDetails,
									 List<String> moreSkus,
									 @Nullable QueryInventoryFinishedListener listener) {
    ...
    // Workaround to bug __fragment_map sometimes response codes come as Long instead of Integer
    ...
    private int querySkuDetails(String itemType, @NonNull Inventory inv, @Nullable List<String> moreSkus)
    ...
    private void consumeAsyncInternal(@NonNull List<Purchase> purchases,
