...
public class STATS_GLOBAL implements Serializable {
	...
	public STATS_GLOBAL(Long menfinder, Long womenfinder, Long bisexfinder, Long gayfinder, Long lesbianfinder, Long gaycuddles, Long gayradar, Long hombre_bi, Long hombre_gay, Long hombre_hetero, Long mujer_bi, Long mujer_hetero, Long mujer_lesbiana, Long total_usuarios) {
	...
	public Long getgaycuddles() {
		return gaycuddles;
	}

	public void setgaycuddles(Long gaycuddles) {
		this.gaycuddles = gaycuddles;
	}
