...
public class STATS_GLOBAL implements Serializable {
	...
	public STATS_GLOBAL(Long menfinder, Long womenfinder, Long bisexfinder, Long gayfinder, Long lesbianfinder, Long womencuddles, Long gayradar, Long hombre_bi, Long hombre_gay, Long hombre_hetero, Long mujer_bi, Long mujer_hetero, Long mujer_lesbiana, Long total_usuarios) {
		...
		this.womencuddles = womencuddles;
	...
	public Long getwomencuddles() {
		return womencuddles;
	}

	public void setwomencuddles(Long womencuddles) {
		this.womencuddles = womencuddles;
	}
