...
public class Activity_Compras extends AppCompatActivity  {
	...
	private void inicializa_anuncios(){
		try{
			...
			utils.registra_error(e.toString(), "inicializa_anuncios de Activity_Compras");
		}
	}
