...
import com.rubisoft.womencuddles.databinding.LayoutEstrellasGratisBinding;
	...
	private void inicializa_anuncios(){
		try{
			if (!perfil_usuario.getBoolean(getString(R.string.PERFIL_USUARIO_ES_PREMIUM), false)) {
				...
				Appodeal.initialize(this, getResources().getString(R.string.APPODEAL_APP_KEY), Appodeal.BANNER| Appodeal.REWARDED_VIDEO, consent);
			}else {
