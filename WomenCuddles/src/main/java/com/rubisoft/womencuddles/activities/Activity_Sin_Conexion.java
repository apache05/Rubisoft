...
import com.rubisoft.womencuddles.databinding.LayoutSinConexionBinding;
...
public class Activity_Sin_Conexion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		com.rubisoft.womencuddles.databinding.LayoutSinConexionBinding binding = LayoutSinConexionBinding.inflate(getLayoutInflater());
