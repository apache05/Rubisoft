...
import com.rubisoft.lesbianradar.databinding.LayoutSinConexionBinding;
...
public class Activity_Sin_Conexion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		com.rubisoft.lesbianradar.databinding.LayoutSinConexionBinding binding = LayoutSinConexionBinding.inflate(getLayoutInflater());
