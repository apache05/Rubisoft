package com.rubisoft.menradar.Fragments;
...
import com.rubisoft.menradar.Adapters.Image_Adapter;
import com.rubisoft.menradar.BuildConfig;
import com.rubisoft.menradar.Classes.Mi_foto;
import com.rubisoft.menradar.Classes.NpaGridLayoutManager;
import com.rubisoft.menradar.Interfaces.Interface_ClickListener_Menu;
import com.rubisoft.menradar.R;
import com.rubisoft.menradar.activities.Activity_Mi_Perfil;
...
//import com.example.ruben.backend.endpointPerfilApi.EndpointPerfilApi;
//import com.example.ruben.backend.endpointPerfilApi.model.BeanPerfil;
...
public class fragment_foto_manager extends Fragment{
	...
	private ConstraintLayout ConstraintLayout_botonera;
	private TextView mTextView_advertencia;
    private boolean es_premium;
  //  private boolean[] existe_foto_usuario; //guardamos en un array si el usuario ha puesto una foto o esta no_pic
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            ...
            //inicializa_existe_foto_usuario();
            mTextView_advertencia = rootView.findViewById(R.id.advertencia);
            ...
            mRecyclerView = rootView.findViewById(R.id.Fragment_foto_manager_ReciclerView); //para la matriz de fotos
			ConstraintLayout_botonera = rootView.findViewById(R.id.Dialogo_cambiar_foto_LinearLayout_botonera);
			...
			AppCompatImageView Button_cambiar_foto = rootView.findViewById(R.id.Dialogo_cambiar_foto_Button_cambiar_foto);
			...
			AppCompatImageView Button_capturar_foto = rootView.findViewById(R.id.Dialogo_cambiar_foto_Button_hacer_foto);
			...
			AppCompatImageView Button_borrar_foto = rootView.findViewById(R.id.Dialogo_cambiar_foto_Button_borrar_foto);
    ...
    private void crea_ItemTouchListener_perfiles() {
        ...
        mRecyclerView.addOnItemTouchListener(new fragment_foto_manager.RecyclerTouchListener_perfiles(getContext(), mRecyclerView, (view, position) -> {
   ...
   /* private void inicializa_existe_foto_usuario() {
        existe_foto_usuario = new boolean[getResources().getInteger(R.integer.NUM_MAX_FOTOS_PREMIUM)];
        for (int i = 0; i < existe_foto_usuario.length; i++) {
            existe_foto_usuario[i] = false;
        }
    }*/
    ...
    private void Setup_RecyclerView() {
        try {
            ...
            mRecyclerView.setLayoutManager(mi_LinearLayoutManager);
        } catch (Exception e) {
					...
					Target target = new Target() {
						...
						public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
							...
							mAppCompatImageView.setOnClickListener(v -> {
								...
								if (ConstraintLayout_botonera.getVisibility() == View.INVISIBLE) {
									mTextView_advertencia.setVisibility(View.INVISIBLE);
									ConstraintLayout_botonera.setVisibility(View.VISIBLE);
								} else {
									mTextView_advertencia.setVisibility(View.VISIBLE);
									ConstraintLayout_botonera.setVisibility(View.INVISIBLE);
								}
							});
