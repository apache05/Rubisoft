...
public class STATS_GLOBAL implements Serializable {
	...
	public STATS_GLOBAL(Long menfinder, Long womenfinder, Long bisexfinder, Long gayfinder, Long lesbianfinder, Long lesbiancuddles, Long gayradar, Long hombre_bi, Long hombre_gay, Long hombre_hetero, Long mujer_bi, Long mujer_hetero, Long mujer_lesbiana, Long total_usuarios) {
		...
		this.lesbiancuddles = lesbiancuddles;
	...
	public Long getlesbiancuddles() {
		return lesbiancuddles;
	}

	public void setlesbiancuddles(Long lesbiancuddles) {
		this.lesbiancuddles = lesbiancuddles;
	}
