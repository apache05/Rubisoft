...
public class STATS_RELACIONES  implements Serializable {
	...
	public STATS_RELACIONES(Long menfinder, Long womenfinder, Long bisexfinder, Long gayfinder, Long lesbianfinder, Long lesbiancuddles, Long gayradar, Long total) {
