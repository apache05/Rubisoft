...
class Security {
    ...
    public static boolean verifyPurchase(String base64PublicKey, @NonNull String signedData, String signature) {
        if (TextUtils.isEmpty(signedData) || TextUtils.isEmpty(base64PublicKey) ||
            ...
            Log.e(Security.TAG, "Purchase verification failed: missing data.");
            return false;
        }
	...
	private static boolean verify(PublicKey publicKey, @NonNull String signedData, String signature) {
        ...
        try {
            ...
            Log.e(Security.TAG, "Base64 decoding failed.");
            return false;
        }
        try {
            ...
            if (!sig.verify(signatureBytes)) {
                Log.e(Security.TAG, "Signature verification failed.");
                return false;
            }
            return true;
        } catch (NoSuchAlgorithmException e) {
            Log.e(Security.TAG, "NoSuchAlgorithmException.");
